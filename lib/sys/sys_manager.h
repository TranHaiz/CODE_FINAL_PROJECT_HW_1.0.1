...
typedef enum
{
  ...
  SYS_MANAGER_EVT_PAUSE_CONFIRM,
  SYS_MANAGER_EVT_PAUSE_TIMEOUT,
  ...
  SYS_MANAGER_EVT_NOTI_LOW_BATT,
  SYS_MANAGER_EVT_WARN_DEBT,
  SYS_MANAGER_EVT_CLEAR_DEBT,
  SYS_MANAGER_EVT_HELP,
  SYS_MANAGER_EVT_CHECK_LTE_BAND,
  SYS_MANAGER_EVT_APPLY_DANGER_NOTI,
  SYS_MANAGER_EVT_SYNC_LOCK,
  SYS_MANAGER_EVT_MAX
} sys_manager_event_t;
